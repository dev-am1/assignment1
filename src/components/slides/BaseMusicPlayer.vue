...
<div class=" justify-center">
    <div class="player mx-auto">
      <div class="player__top">
        <div class="player-cover" v-if="index === currentTrackIndex">
        ...
        <div class="flex-col">
          ...
          <div class=" w-12 align-middle justify-center float-left mt-10 mx-2.5">
					<a v-on:click.prevent="" v-on:mouseenter="showVolume = true" v-on:mouseleave="showVolume = false" :title="volumeTitle" href="#">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
							<path fill="#cccccc" d="M19,13.805C19,14.462,18.462,15,17.805,15H1.533c-0.88,0-0.982-0.371-0.229-0.822l16.323-9.055C18.382,4.67,19,5.019,19,5.9V13.805z"/>
						</svg>
      ...
      <div class="progress" ref="progress">
        <div class="progress__top">
          <div class="album-info" v-if="currentTrack">
            <div class="album-info__name mt-8">{{ currentTrack.artist }}</div>
